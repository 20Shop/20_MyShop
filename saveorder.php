...
//Set ว/ด/ป เวลา ให้เป็นของประเทศไทย
	...
	$sql1 = "INSERT  INTO 20_order VALUES
	(NULL,
	'$mem_id',  
	'$name',
	'$address',
	...
	$sql2 = "SELECT MAX(order_id) AS order_id FROM 20_order  WHERE mem_id='$mem_id'";
	...
	{
		$sql3	= "SELECT * FROM 20_product where p_id=$p_id";
	 ...
	 //  for($k=0; $k<$count; $k++){  	
		...
		$sql4	= "INSERT INTO  20_order_detail 
		values(null, 
		'$order_id', 
		'$p_id',
		'$p_name', 
		...
		$sqlpname ="UPDATE 20_order_detail t2, 
		(
		SELECT p_name, p_id FROM 20_product
		) 
		t1 
