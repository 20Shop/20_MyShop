...
$query_prdt = sprintf("SELECT * FROM 20_product WHERE p_id = %s", GetSQLValueString($colname_prdt, "int"));
...
//update product view
$p_id = $row_prdt['p_id'];
$p_amount = $row_prdt['p_amount'];
$count = $p_amount + 1;

$sql= "UPDATE 20_product SET  p_amount=$count WHERE p_id = $p_id";
...
<body>
   ...
   <h4>  ชื่อสินค้า :  <?php echo $row_prdt['p_name']; ?> </h4>
    ...
    จำนวนคงเหลือสินค้า <?php echo $row_prdt['p_amount']; ?>    
