...
$query_buyer = sprintf("SELECT * FROM 20_member WHERE mem_username = %s", GetSQLValueString($colname_buyer, "text"));
...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <?php do { ?>
    ...
    <tr>
      ...
      (ไฟล์ .jpg, png, pdf&nbsp;ไม่เกิน 2mb)</td>
    </tr>
    <tr>
      <td align="center">&nbsp;</td>
      <td align="center">&nbsp;</td>
