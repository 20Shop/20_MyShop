<?php
	...
	?>
      ...
      <form id="frmcart" name="frmcart" method="post" action="?act=update">
        ...
        <tr>
          <td height="40" colspan="4" align="center" bgcolor="#FFCCCC"><strong><b>ตะกร้าสินค้า</strong></td>
        </tr>
        <tr>
...
require_once('Connections/condb.php');
	...
	{
		$sql = "select * from 20_product where p_id=$p_id";
...
?>
       ...
       <p align="right">   
        <?php if($total > 0){ ?>
          ...
          <button type="submit" name="button" id="button" class="btn btn-warning"> ยืนยัน </button>
          <?php $chk = $_GET['act'];
		      if($chk=='update'){?>
