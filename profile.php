...
$query_pf = sprintf("SELECT * FROM 20_member WHERE mem_username = %s", GetSQLValueString($colname_pf, "text"));
 ...
 <div class="container">
 	<div class="row">
        ...
        <div class="col-md-6">
            ...
            โปรไฟล์ : <?php echo $row_pf['mem_name']; ?>  <a href="profile.php?do=edit-profile" class="btn btn-warning btn-xs">แก้ไข</a> <br>
