...
$query_mlogin = sprintf("SELECT * FROM 20_member WHERE mem_username = %s", GetSQLValueString($colname_mlogin, "text"));
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php">หน้าหลักสินค้า</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <b>  ค้นหาสินค้า  </b> 
          <input type="text" class="form-control" placeholder="ระบุชื่อสินค้า" name="q">
        </div>
        ...
        <?php 
			...
			if($mm !=''){
				...
				echo  " ท่านผู้เจริญ" .$row_mlogin['mem_name'];
				echo "</a>";
				echo "</li>";
